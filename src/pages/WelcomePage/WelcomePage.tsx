    ...
    <div className={block()}>
      ...
      >
        <span className={block("welcome")}>
          День открытых дверей ДГТУ в очном формате <br />
          11 апреля 2021 года <br />с 9.30 до 12.30
        </span>
        ...
        <span className={block("introduction")}>
          ...
          <span className={block("regular")}>
            <ul>
              <li>встреча с руководством вуза;</li>
              <li>
                презентации факультетов и структур довузовской подготовки;
              </li>
              <li>
                знакомство с программами международной академической
                мобильности и поступлением по «Зеленой волне».
              </li>
            </ul>
          Количество мест ограничено. Необходима предварительная регистрация на
          мероприятия в разделах «Встреча с руководством», «Привет, факультет!»
          и «Довуз». День открытых дверей пройдет по адресу: г. Ростов-на-Дону,
          пл. Гагарина, 1. Вход через Главный корпус ДГТУ или через
          Конгресс-Холл.
        </span>
        <Brick size={3} />
        <span className={block("regular")}>
          ...
          если хочешь получить за участие в дне открытых дверей баллы, которые
          можно будет использовать после зачисления в ВУЗ.
          {/* <ul>
            <li>
            ...
            <li>предварительно оценить свои индивидуальные достижения.</li>
          </ul> */}
        </span>
        <br />
      </motion.div>
